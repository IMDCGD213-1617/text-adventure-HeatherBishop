    ...
    static class TextUtilities
    {
        ...
        public static string ExtractArguments(string line)
        {
            ...
            if (index == -1)
                ...
                return line.Substring(index + 1, line.Length - index - 1); //(pos of space, +1 to ignore space and start at argument, how many characters until the end of the line? Overall length - index)
