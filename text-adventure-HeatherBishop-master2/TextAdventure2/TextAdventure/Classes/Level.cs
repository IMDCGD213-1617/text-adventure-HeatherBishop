...
namespace TextAdventure
{
    static class Level
    {
        ...
        private static void BuildLevel()
        {
            ...
            room.RoomDescription = "You have arrived at Corridor C. There is a suspicious stain on the floor. The smell of food and coffee tempts you to move East.";
            ...
            room.RoomDescription = "You have entered Denise's Office.";
            ...
            room.RoomDescription = "You have arrived in the Boiler Room. Its sweltering hot because of the furnace roaring to the side of you.";
